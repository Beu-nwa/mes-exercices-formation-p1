...
// le component react update systematiquement son contenu alors que le pureComponent react (qui augmente les performances) a une methode shouldComponenentUpdate() qui ne le fait pas systematiquement. En cas de problème, il existe la methode forceUpdate().
